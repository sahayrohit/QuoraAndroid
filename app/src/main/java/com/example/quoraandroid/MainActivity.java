...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener ,PostAdapter.PostClick{
    ...
    private ImageView addQuestionBtn;
...
mSearchBtn.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        addQuestionBtn = (ImageView) findViewById(R.id.home_add_question_btn_img);
        ...
        Toast.makeText(this, "accessToken: "+account, Toast.LENGTH_SHORT).show();
...
//        // [END subscribe_topics]
    ...
    private void sendToSearch() {
        Intent seach_intent = new Intent(MainActivity.this,SearchActivity.class);
        startActivity(seach_intent);
    }

    private void sendToAddQuestion() {
        Intent add_Question_intent = new Intent(MainActivity.this,AddQuestionActivity.class);
        startActivity(add_Question_intent);
    }
    ...
    private void updateUI(String account) {
        ...
        if( account != null ){
            ...
            Toast.makeText(this, "from update ui:token:"+account, Toast.LENGTH_SHORT).show();
...
//                    navUsername.setText(profileDto.getName());
                    Glide.with(MainActivity.this).applyDefaultRequestOptions(new RequestOptions().placeholder(R.drawable.avatar))
        ...
        //change drawer logout/login to logout
            ...
            Toast.makeText(this, "from update ui:token: null", Toast.LENGTH_SHORT).show();
            Menu menu = navigationView.getMenu();
